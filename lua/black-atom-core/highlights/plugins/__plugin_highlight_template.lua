--[[
    ...
    in the `lua/black-atom-core/highlights/plugins/` folder will be loaded automatically.
    Note: Filenames ending with "_template.lua" will be disregarded!

    Each highlight file must return a `BlackAtomCore.HighlightsSpec` table,
    which at a minimum, should contain a field called `map`.
    The `BlackAtomCore.HighlightsSpec` and `BlackAtomCore.Highlights` types
    ...
    The `map` function needs to return a `BlackAtomCore.Highlights` table.
    ...
    inside "lua/black-atom-core/config.lua" to see a generated file with all highlights.
