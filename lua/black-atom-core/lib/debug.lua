local lib_files = require("black-atom-core.lib.files")
local lib_ui = require("black-atom-core.lib.ui")
...
---@param modules string[] -@param highlights_map BlackAtomCore.HighlightsMap
---@return nil
M.write_debug_highlights_file = function(modules, highlights_map)
    ...
    if file then
        ...
        -- Highlight map
        file:write("\n")
        file:write("Complete Black Atom Core Highlight Map" .. "\n")
        file:write("\n")
