...
function M.main(config, colors)
    ...
    return require("black-atom-core.lib.highlights").conditional_hl(bg.primary.main, {
...
function M.sidebar(config, colors)
    ...
    return require("black-atom-core.lib.highlights").conditional_hl(bg.primary.dark, {
