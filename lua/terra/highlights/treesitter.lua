...
M.setup = function(highlights, colors, config)
    highlights.treesitter = {
        ["@annotation"] = { fg = colors.semantics.fg.main },
        ...
        ["@error"] = { fg = colors.semantics.fg.main },
        ...
        ["@none"] = { fg = colors.semantics.fg.main },
        ["@number"] = { fg = colors.palette.dark_yellow },
        ["@operator"] = { link = "Operator" },
        ["@parameter"] = { fg = colors.palette.dark_yellow, italic = true },
        ["@parameter.reference"] = { fg = colors.semantics.fg.main },
        ["@property"] = { fg = colors.palette.dark_blue },
        ["@punctuation.delimiter"] = { fg = colors.semantics.fg.main },
        ["@punctuation.bracket"] = { fg = colors.semantics.fg.main },
        ["@punctuation.special"] = { fg = colors.semantics.fg.main },
        ...
        ["@text"] = { fg = colors.semantics.fg.main },
        ["@text.strong"] = { fg = colors.semantics.fg.main, bold = true },
        ["@text.emphasis"] = { fg = colors.semantics.fg.main, italic = true },
        ["@text.underline"] = { fg = colors.semantics.fg.main, underline = true },
        ["@text.strike"] = { fg = colors.semantics.fg.main, strikethrough = true },
        ...
        ["@text.math"] = { fg = colors.semantics.fg.main },
        ["@text.reference"] = { fg = colors.palette.blue },
        ["@text.environment"] = { fg = colors.semantics.fg.main },
        ["@text.environment.name"] = { fg = colors.semantics.fg.main },
        ["@text.note"] = { fg = colors.semantics.fg.main },
        ["@text.warning"] = { fg = colors.semantics.fg.main },
        ["@text.danger"] = { fg = colors.semantics.fg.main },
