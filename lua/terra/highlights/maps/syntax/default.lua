...
local highlight_map_extension = {
    map = function(colors, config)
        ...
        local highlights_map = {
            ...
            Function = extend({ fg = palette.yellow }, config.code_style.functions),
            Identifier = extend({ fg = fg.active }, config.code_style.variables),
            Include = { fg = palette.magenta },
            Keyword = extend({ fg = palette.magenta }, config.code_style.keywords),
            ...
            SpecialComment = extend({ fg = fg.secondary.dark }, config.code_style.comments),
            Statement = { fg = palette.magenta },
            StorageClass = { fg = palette.blue },
            String = extend({ fg = palette.cyan }, config.code_style.strings),
            ...
            ["@string"] = extend({ fg = palette.green }, config.code_style.strings),
            ["@string.escape"] = extend({ fg = palette.red }, config.code_style.strings),
            ["@string.regex"] = extend({ fg = palette.dark_yellow }, config.code_style.strings),
            ["@string.special"] = extend({ fg = palette.green }, config.code_style.strings),
            ...
            ["@variable"] = extend({ fg = palette.blue }, config.code_style.variables),
            ["@variable.builtin"] = extend({ fg = palette.blue }, config.code_style.variables),
