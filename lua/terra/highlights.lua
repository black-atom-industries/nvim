...
hl.treesitter = {
	...
	TSStringRegex = { fg = colors.dark_yellow, fmt = config.code_style.strings },
	...
	TSTitle = { fg = colors.dark_yellow, fmt = "bold" },
...
hl.plugins.nvim_tree = {
	...
	NvimTreeRootFolder = { fg = colors.dark_yellow, fmt = "bold" },
...
hl.plugins.telescope = {
	...
	TelescopeMatching = { fg = colors.dark_yellow, fmt = "bold" },
...
hl.langs.markdown = {
	...
	markdownH3 = { fg = colors.dark_yellow, fmt = "bold" },
	markdownH4 = { fg = colors.red, fmt = "bold" },
	markdownH5 = { fg = colors.purple, fmt = "bold" },
	markdownH6 = { fg = colors.dark_yellow, fmt = "bold" },
...
hl.langs.php = {
	...
	phpVarSelector = { fg = colors.dark_yellow, fmt = config.code_style.variables },
	phpIdentifier = { fg = colors.dark_yellow, fmt = config.code_style.variables },
...
local lsp_kind_icons_color = {
	...
	Field = colors.purple,
	File = colors.blue,
	Folder = colors.dark_yellow,
	Function = colors.blue,
	Interface = colors.green,
	Keyword = colors.cyan,
	Method = colors.blue,
	Module = colors.dark_yellow,
	Operator = colors.red,
	Property = colors.cyan,
	Reference = colors.dark_yellow,
	Snippet = colors.red,
	Struct = colors.purple,
	Text = colors.light_grey,
	TypeParameter = colors.red,
	Unit = colors.green,
	Value = colors.dark_yellow,
