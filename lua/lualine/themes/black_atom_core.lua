local cond_hl = require("black-atom-core.lib").hls.conditional_hl
...
M.normal = {
    ...
    b = {
        ...
        bg = cond_hl(bg.primary.main, {
            [BlackAtomCoreConfig.styles.transparency == "partial"] = bg.primary.main,
            [BlackAtomCoreConfig.styles.transparency == "full"] = colors.none,
        }),
    },
    c = {
        fg = fg.primary.dark,
