...
local highlight_map_extension = {
    map = function(colors, config)
        ...
        local highlights_map = {
            -- Basic Text
            Normal = { fg = fg.primary.main, bg = utils.bg.main(config, colors) },
            NormalNC = { fg = fg.primary.main, bg = utils.bg.main(config, colors) },
            EndOfBuffer = { fg = utils.hl.conditional_hl(bg.primary.main, { [config.ending_tildes] = fg.neutral }) },
            ...
            Comment = utils.hl.extend_hl({ fg = fg.neutral }, config.code_style.comments),
            Conditional = utils.hl.extend_hl({ fg = palette.magenta }, config.code_style.keywords),
            ...
            Function = utils.hl.extend_hl({ fg = palette.yellow }, config.code_style.functions),
            Identifier = utils.hl.extend_hl({ fg = fg.active }, config.code_style.variables),
            Include = { fg = palette.magenta },
            Keyword = utils.hl.extend_hl({ fg = palette.red }, config.code_style.keywords),
            ...
            Repeat = utils.hl.extend_hl({ fg = palette.magenta }, config.code_style.keywords),
            Special = { fg = palette.red },
            SpecialChar = { fg = palette.red },
            SpecialComment = utils.hl.extend_hl({ fg = fg.secondary.dark }, config.code_style.comments),
            Statement = { fg = palette.magenta },
            StorageClass = { fg = palette.blue },
            String = utils.hl.extend_hl({ fg = palette.cyan }, config.code_style.strings),
            ...
            -- Messages & Mode
            ErrorMsg = utils.hl.extend_hl({
                fg = palette.red,
            }, config.code_style.messages),
            MoreMsg = utils.hl.extend_hl({
                fg = palette.blue,
            }, config.code_style.messages),
            ModeMsg = utils.hl.extend_hl({ fg = fg.primary.main }, config.code_style.messages),
            WarningMsg = utils.hl.extend_hl({ fg = palette.yellow }, config.code_style.messages),

            -- Window & Tab Management
            Title = { fg = fg.active },
            StatusLine = {
                fg = fg.primary.main,
                bg = utils.hl.conditional_hl(bg.primary.dark, { [config.transparency == "full"] = colors.none }),
            },
            StatusLineNC = {
                fg = fg.neutral,
                bg = utils.hl.conditional_hl(bg.primary.dark, { [config.transparency == "full"] = colors.none }),
            ...
            WinSeparator = { fg = bg.primary.dark, bg = utils.bg.main(config, colors) },

            -- Folds & Signs
            Folded = { fg = fg.neutral, bg = utils.bg.main(config, colors) },
